            ...
            <Table sx={{ minWidth: 650 }} size="small" aria-label="a dense table">
                ...
                {tarefas.map((row, indice) => (
                    ...
                    >
                      ...
                      <TableCell align="right" sx={{
                      background:'#4d393c',
                    }}>{row.descricaoTarefa}</TableCell>
                      <TableCell align="right"sx={{
                      background:'#4d393c',
                    }}>{row.inicioTarefa}</TableCell>
                      <TableCell align="right"sx={{
                      background:'#4d393c',
                    }}>{row.fimTarefa}</TableCell>
                      <TableCell align="right"sx={{
                      background:'#4d393c',
                    }}>{row.statusTarefa}</TableCell>
                      <TableCell align="right"sx={{
                      background:'#4d393c',
                    }}>{row.recursoTarefa}</TableCell>
                      <TableCell align="center" sx={{
                      background:'#4d393c',
                    }}>
                        <Button variant="contained" color="success" onClick={() => handleEditar(row.idTarefa)} sx={{
                          background:'#2f2626'
                      ...
                      background:'#4d393c',
                        ...
                        <Button variant="contained" color="error" onClick={() => handleDeletar(row.idTarefa)} sx={{
                          background:'#450606'}}><DeleteIcon fontSize="small" /></Button>            
                      </TableCell>
                    </TableRow>
                ))}
                </TableBody>
